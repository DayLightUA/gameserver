package pavlo.zayarnyuk.gameserver.security.tokenUtils;


import pavlo.zayarnyuk.gameserver.security.dto.TokenUser;
...
//        LOGGER.info("Creating token");
        try {
              token = Jwts.builder().setIssuer("LogosProject")
                    .claim("login",login)
                    .claim("role",role)
